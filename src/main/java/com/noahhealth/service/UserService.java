...
//            }
    ...
    public void setUserExtendInfo(Map params, User user) {
        ...
        String bloodType = (String) params.get("bloodType"); // 血型
        String baseTemperature = (String) params.get("baseTemperature"); // 基础体温
        String breath = (String) params.get("breath"); //呼吸
        String bloodPressure = (String) params.get("bloodPressure"); // 血压
        String heartRate = (String) params.get("heartRate"); // 心率
        String heartRate2 = (String) params.get("heartRate2"); // 心律
        String height = (String) params.get("height"); // 身高
        String weight = (String) params.get("weight");//体重
        String weightRate = (String) params.get("weightRate");//体重指数
        String waistCircum = (String) params.get("waistCircum");//腰围
        String armCircum = (String) params.get("armCircum");//臂围
        String waistArmRate = (String) params.get("waistArmRate");//腰臂比
        ...
        String surgery = (String) params.get("surgery");//手术史
        String family = (String) params.get("family");//家族史
        String disease = (String) params.get("disease");//主要疾病
        String medication = (String) params.get("medication");//主要用药
        String special = (String) params.get("special");//特殊事项
        if (birth != null) {
            user.setBirth(birth);
        }
        ...
        if (!Validator.checkEmpty(baseTemperature)) {
            user.setBaseTemperature(baseTemperature);
        }
        ...
        if (!Validator.checkEmpty(weightRate)) {
            user.setWeightRate(weightRate);
        }
        if (!Validator.checkEmpty(waistCircum)) {
            user.setWaistCircum(waistCircum);
        }
        if (!Validator.checkEmpty(armCircum)) {
            user.setArmCircum(armCircum);
        }
        if (!Validator.checkEmpty(waistArmRate)) {
            user.setWaistArmRate(waistArmRate);
        }
